...
unsigned
   ...
   buffer_top = 0;     // "puntero" a la posición donde producir datos del buffer
Semaphore
...
{
   cout << "----------------------------------------------------------------------------------------" << endl
        << "Problema de los productores-consumidores ( solución LIFO ). Un solo productor-consumidor" << endl
        << "----------------------------------------------------------------------------------------" << endl
        << flush ;
